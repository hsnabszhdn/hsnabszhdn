...
spec:
  summary: |
    ...
    I am now a DevOps/Cloud Engineer, creating and maintaining build/deployment pipelines, cloud infrastructure, as well as Linux virtual servers for SSH and VPN access.
  educations:
